...
var DotaBuffCP = {
  ...
  heroAbbrLookup: {
    ...
    "bane": ["atropos"],
    "batrider": [],
    "beastmaster": ["bm", "karroch", "rexxar"],
    "bloodseeker": ["bs", "strygwyr"],
    "bounty hunter": ["bh", "gondar"],
    "brewmaster": ["bm", "mangix"],
    "bristleback": ["bb", "rigwarl"],
    "broodmother": ["bm"],
    "centaur warrunner": ["cw", "bradwarden"],
    "chaos knight": ["ck"],
    "chen": [],
    "clinkz": ["bone"],
    ...
    "dazzle": [],
    "death prophet": ["dp", "krobelus", "grobulus"],
    "disruptor": [],
    "doom": [],
    ...
    "meepo": ["geomancer"],
    "mirana": ["potm"],
    "monkey king": ["mk", "sun wukong"],
    "morphling": [],
    "naga siren": ["ns", "slithice"],
    "natures prophet": ["np", "furion"],
    "necrophos": [],
    ...
    "sniper": ["kardel"],
    "spectre": ["mercurial"],
    "spirit breaker": ["sb", "barathrum"],
    "storm spirit": ["ss", "raijin"],
    "sven": [],
    "techies": ["goblin","gt","sqee","spleen","spoon"],
    "templar assassin": ["ta", "lanaya"],
    "terrorblade": ["tb"],
    "tidehunter": ["th", "leviathan"],
    "timbersaw": ["ts", "rizzrack"],
    "tinker": ["boush"],
    "tiny": [],
    "treant protector": ["tp", "rooftrellen"],
    "troll warlord": ["tw"],
    "tusk": ["ymir"],
    "underlord": ["vrogros"],
    "undying": ["dirge"],
    "ursa": [],
    "vengeful spirit": ["vs", "shendelzare"],
    "venomancer": ["lesale"],
    "viper": ["netherdrake"],
    "visage": [],
    "warlock": ["wl", "demnok"],
    "weaver": ["skitskurr"],
    "windranger": ["wr", "lyralei"],
    "winter wyvern": ["ww"],
    "witch doctor": ["wd", "zharvakko"],
    "wraith king": ["wk", "ostarion", "skeleton king", "sk"],
    "zeus": []
  },
